 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "CAPTION_ENGINE = \"gemini\" #@param [\"gemini (Google Cloud Vision - 0% VRAM)\", \"florence2 (Florence-2 / JoyCaption Local VLM)\", \"deepseek (Cloud API OpenAI format)\", \"wd14 (Anime / Danbooru tags - Local)\", \"skip_captioning (Da co san file .txt)\"]\n",
