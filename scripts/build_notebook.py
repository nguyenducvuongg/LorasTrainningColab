 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# 2. Cài đặt các thư viện cần thiết (Tối ưu chống xung đột Colab)\n",
    "print(\"⚡ Cài đặt dependencies...\")\n",
    "!pip install -q \"setuptools<82\" \"jedi>=0.16\"\n",
    "!pip install -q accelerate transformers diffusers peft safetensors huggingface-hub bitsandbytes rich pyyaml toml google-genai openai\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "SELECTED_MODEL = \"flux-dev\" #@param [\"flux-dev\", \"flux-schnell\", \"flux-kontext\", \"krea2-raw\", \"sdxl-base\", \"pony-v6\", \"illustrious-xl\", \"sd35-medium\", \"sd15-base\"]\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "CAPTION_ENGINE = \"gemini\" #@param [\"gemini\", \"deepseek\", \"wd14\", \"joycaption\", \"skip_captioning\"]\n",
