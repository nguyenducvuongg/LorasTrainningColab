 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "CAPTION_ENGINE = \"gemini (Google Cloud Vision - 0% VRAM)\" #@param [\"gemini (Google Cloud Vision - 0% VRAM)\", \"florence2 (Florence-2 Large Local VLM)\", \"joycaption (JoyCaption Alpha Two LLM)\", \"deepseek (Cloud API OpenAI format)\", \"wd14 (Anime / Danbooru tags - Local)\", \"skip_captioning (Da co san file .txt)\"]\n",
